...
const AssistantChat = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]">
      {isOpen ? (
        <div className="w-[380px] h-[550px] bg-surface-dark/95 backdrop-blur-xl border border-primary/30 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <button
          ...
          className="w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-glow hover:shadow-glow-hover hover:scale-110 transition-all duration-300 group relative overflow-hidden"
        >
          ...
          <span className="material-symbols-outlined text-white text-3xl group-hover:rotate-12 transition-transform relative z-10">
            smart_toy
          </span>
        </button>
      )}
